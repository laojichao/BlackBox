...
//		}
	 ...
	 * The resource request will then be forwarded to another {@link Resources}
	 ...
	 * {@link Resources} instance. Such resources can be replaced in
...
//		int[] mCachedXmlBlockIds = (int[]) getObjectField(res, "mCachedXmlBlockIds");
	...
	/**
	 * Makes any individual resource available from another {@link Resources}
